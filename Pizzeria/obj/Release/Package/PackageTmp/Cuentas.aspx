    ...
    <div class="form-group">
        ...
        <div class="jumbotron form-group">
         ...
         <div style="width:504px">
             ...
             Fecha Desde: <input type="text" id="pickerDesde"  name="Desde" class="form-control" style="width: 187px; height: 24px;">
             ...
             Hora Desde: <input type="text" id="timepickerDesde" name="Desde" class="form-control" style="Width:187px; height:24px;">
         ...
         <div style="width:503px">
             ...
             Fecha Hasta: <input type="text" id="pickerHasta" name="Hasta" class="form-control" style="Width:187px; height:24px;" required>
             ...
             Hora Hasta: <input type="text" id="timepickerHasta" name="Hasta" class="form-control" style="Width:187px; height:24px;" required>
