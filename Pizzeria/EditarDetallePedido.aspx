    ...
    <div>
        ...
        <div class="jumbotron">
            <div style="Width:410px">
                ...
                <asp:TextBox id="txtIdDetalle" runat="server" Width="300px" class="derechaBox form-control" Enabled="false"/>
                <br />
                <br />
                <asp:Label id="lblTipo" Text="Tipo: " runat="server" class="medidaBox text-align:left"/>
                <asp:TextBox id="txtTipo" runat="server" Width="300px" class="derechaBox form-control"/>
                <br />
                <br />
                <asp:Label id="lblMenu" Text="Menu: " runat="server" class="medidaBox text-align:left"/>
                <asp:TextBox id="txtMenu" runat="server" Width="300px" class="derechaBox form-control"/>
                <br />
                <br />
                <asp:Label id="lblParaPizza" Text="Para Pizza: " runat="server" class="medidaBox text-align:left"/>
                <asp:TextBox id="txtParaPizza" runat="server" Width="300px" class="derechaBox form-control"/>
                <br />
                <br />
                <asp:Label id="lblCantidad" Text="Cantidad: " runat="server" class="medidaBox text-align:left"/>
                <asp:TextBox id="txtCantidad" runat="server" Width="300px" class="derechaBox form-control"/>    
                <br />
                <br />
              
                <asp:Label id="lblPrecio" Text="Precio: " runat="server" class="medidaBox text-align:left" />
                <asp:TextBox id="txtPrecio" runat="server" Width="300px" class="derechaBox form-control" Enabled="false"/>          
        ...
        <br />
        <p>
            <asp:Button id="btnAceptar" Text="Aceptar" runat="server" OnClick="btnAceptar_Click" class="btn btn-primary"/>
