...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script> // 580
        ...
        function copia_portapapeles() {
            ...
            window.clipboardData.setData("Text", "LOGAN");
        };
        function copiarAlPortapapeles(id_elemento) {
            var aux = document.createElement("input");
           
            aux.setAttribute("value", document.getElementById(id_elemento).innerHTML);//document.getElementById(id_elemento).innerHTML
    ...
    <h1>Pedidos</h1>
        ...
        <asp:Label Text="BUSCAR:" runat="server" style="padding:12px" />
            <br />
        <asp:TextBox ID="txtSearchCodigo" runat="server" Text="*Codigo" onblur="LimpiarTexto()" Width="84px" />
        <asp:TextBox ID="txtSearchNombreCliente" runat="server" Text="*Nombre de cliente" onblur="LimpiarTexto()" Width="169px" Style="text-transform: uppercase"/>
        <asp:TextBox ID="TxtSearchDireccion" runat="server" Text="*Dirección" Width="177px" Style="text-transform: uppercase"/>
        <asp:TextBox ID="txtSearchFecha" runat="server" Text="*Fecha/Hora" Width="113px" Style="text-transform: uppercase"/>
        <asp:TextBox ID="txtSearchEstado" runat="server" Text="*Estado" Width="94px" Style="text-transform: uppercase"/>
        <asp:TextBox ID="txtSearchAvisar" runat="server" Text="*Avisar" Width="81px" Style="text-transform: uppercase"/>
            <asp:TextBox ID="txtSearchModoPago" runat="server" Text="*ModoPago" Width="137px" Style="text-transform: uppercase"/>
        <br />
        <asp:ImageButton ID="btnSearch" ImageUrl="Imagenes/searchbutton.png" runat="server" Height="33px" Width="36px" OnClick="btnSearch_Click"/>
