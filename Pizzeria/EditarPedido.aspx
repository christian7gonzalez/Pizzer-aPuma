    ...
    <div>
        ...
        <div class="jumbotron">
            <div style="Width:410px">
                    ...
                    <asp:TextBox id="txtnombreCliente" runat="server" Width="300px" class="derechaBox form-control"/>
                    <br />
                    <br />
                    <asp:Label id="lbldireccion" Text="Dirección: " runat="server" class="medidaBox text-align:left"/>
                    <asp:TextBox id="txtdireccion" runat="server" Width="300px" class="derechaBox form-control"/>
                    <br />
                    <br />
                    <asp:Label id="lblnota" Text="Nota: " runat="server" class="medidaBox text-align:left"/>
                    <asp:TextBox id="txtnota" runat="server" Width="300px" class="derechaBox form-control"/>   
                    <br />
                    <br />
                    <asp:Label id="lblAtencion" Text="Atención: " runat="server" class="medidaBox text-align:left"/>
                    <asp:TextBox id="txtAtencion" runat="server" Width="300px" class="derechaBox form-control"/>  
            </div>           
        </div>
        <div class="jumbotron">
            <h3>Pedido:</h3>
            ...
            <div style="Width:171px" class="derechaBox">
                 ...
                 <asp:TextBox id="txtTotal" runat="server" Width="115px" display="inline-block"  Enabled="false" CssClase="derechaBox form-control"/>  
